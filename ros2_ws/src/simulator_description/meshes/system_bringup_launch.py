...
def generate_launch_description():
    ...
    simulator_description_pkg_path = FindPackageShare('simulator_description')  # Replace with your own package name
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                'gz_args': PathJoinSubstitution([simulator_description_pkg_path, 'worlds/empty_custom_world.sdf']),  # Replace with your own world file
